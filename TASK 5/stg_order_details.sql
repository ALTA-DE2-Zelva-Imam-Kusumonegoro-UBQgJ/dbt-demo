WITH base AS (
    SELECT
        ...
        order_details.price, 
        {{ normalized_phone_number('customer_phone') }} AS normalized_phone
    FROM
...
SELECT
    ...
    CASE
        WHEN base.normalized_phone LIKE '62%' THEN 'Indonesia'
        WHEN base.normalized_phone LIKE '91%' THEN 'India'
        ELSE NULL
    END AS country
FROM
    base
